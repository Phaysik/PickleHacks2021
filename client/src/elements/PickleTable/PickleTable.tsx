import { PickleBoxAttrs, PickleData } from '../../types/PickleBoxAttrs';
...
const PickleTable = ({ pickles }: { pickles: PickleData[] }) => {
	const renderPickle = (props: PickleBoxAttrs) => (
		<PickleBox key={props.id} {...props} />
	);
